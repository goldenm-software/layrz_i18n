...
/// The unique identifier of the language.
 String? get id;/// The display name of the language in its native language.
///
/// Example: "English", "Français", "Español"
 String? get name;/// The language code (e.g., "en", "fr", "es-ES").
 String? get code;/// The fallback language code if this language is not available.
 String? get fallback;/// A map of translation keys to translated message strings.
///
...
class _AvailableLanguage extends AvailableLanguage {
   _AvailableLanguage({this.id, this.name, this.code, this.fallback, this.messages}): super._();
...
///
/// The map is returned as-is and must not be mutated by callers.
@override final  Map<String, String>? messages;
